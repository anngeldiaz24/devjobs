<div class="bg-gray-100 py-10 dark:bg-gray-900">
    <h2 class="text-2xl md:text-4xl text-gray-600 text-center font-extrabold my-5 dark:text-white">Search and Filters Jobs</h2>
    ...
    <div class="max-w-7xl mx-auto">
        <form wire:submit.prevent='leerDatosForm'>
            <div class="md:grid md:grid-cols-3 gap-5">
                <div class="mb-5">
                    <label 
                        class="block mb-1 text-sm text-gray-700 uppercase font-bold dark:text-white"
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold dark:text-white rounded-md">Category</label>
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold dark:text-white rounded-md">Monthly salary</label>
